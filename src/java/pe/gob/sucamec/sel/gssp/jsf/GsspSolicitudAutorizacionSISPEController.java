 ...
 */
@Named(value = "gsspSolicitudAutorizacionSISPEController")
@SessionScoped
public class GsspSolicitudAutorizacionSISPEController implements Serializable {
    ...
    public GsspSolicitudAutorizacionSISPEController() {
        
    }
    
    public void iniciarValores_SISPE() { 
        ...
        regTipoSeguridadSelected = ejbTipoBaseFacade.tipoPorCodProg("TP_GSSP_MOD_SISPE");
    ...
    public void onload_SISPE(){
        RequestContext context = RequestContext.getCurrentInstance();        
        context.execute("PF('wvDlgDeclaracionJuradaSISPE').show()"); 
    ...
    public void mostrarEditarSolicitud(Map item) {
        ...
        setEstado(EstadoCrud.EDITARSISPE);
        setTermCondicionAceptaDDJJ(false);
        setRegistro(registro);
        iniciarValores_SISPE_Editar(registro);
    ...
    public String mostrarVerSolicitud(Map item) {
        ...
        registro = ejbSspRegistroFacade.find((Long) item.get("ID")); 
        setRegistro(registro);
        setEstado(EstadoCrud.VERSISPE);
        setTermCondicionAceptaDDJJ(false);
        iniciarValores_SISPE_Ver(registro);            
        ExternalContext ec = FacesContext.getCurrentInstance().getExternalContext();
        try {
    ...
    public String validarSiguienteSolicAutorizacion(TipoBaseGt regTipoSeguridadSelected, TipoBaseGt tbTipoRegistroSelected) {
        ...
        ListSolicitudPresentados = ejbSspRegistroFacade.listaSolitudesPresentados_Vigentes("TP_GSSP_MOD_SISPE", regUserAdminist.getId());
        ...
        if(validacion == true){
            if(ListSolicitudPresentados != null){
                setEstado(EstadoCrud.EXISTESISPE);                
                URL_Formulario = "/aplicacion/gssp/gsspSolicitudAutorizacion/ExisteRegistro"; 
            }else{
                setEstado(EstadoCrud.CREARSISPE);       
                iniciarValores_SISPE();
                URL_Formulario = "/aplicacion/gssp/gsspSolicitudAutorizacion/sispe/CreateSispe"; 
            }
        }
    ...
    public void btnAceptarDDJJ(){        
       ...
       RequestContext context = RequestContext.getCurrentInstance();       
       context.update("FormSISPE");
       context.execute("PF('wvDlgDeclaracionJuradaSISPE').hide()");
    ...
    public String btnCancelarSISPE(){
       termCondicionAceptaDDJJ = false;       
       RequestContext context = RequestContext.getCurrentInstance();
       context.update("FormSISPE");     
    ...
    public String btnCancelarSISPE_Editar(){
       termCondicionAceptaDDJJ = false;       
       RequestContext context = RequestContext.getCurrentInstance();
       context.update("FormSISPE");
    ...
    public String btnRegresarBandejaSISPE(){
       termCondicionAceptaDDJJ = false;       
       registro = new SspRegistro();      
    ...
    public boolean validaRegistroSISPE() {
        boolean validacion = true;
    ...
    public String btnRegistrarSISPE(){
        termCondicionAceptaDDJJ = true;
        
        if (validaRegistroSISPE()) {
    ...
    public void iniciarValores_SISPE_Ver(SspRegistro registro) { 
        
        estado = EstadoCrud.VERSISPE;                
    ...
    public void iniciarValores_SISPE_Editar(SspRegistro registro) { 
    ...
    public String btnEditarSISPE(){
        ...
        if (validaRegistroSISPE()) {
            ...
            try {
                ...
                //===========================================================================                
                adicionaEvento(registro, "Actualiza solicitud de autorización para SISPE.");                        
                //===========================================================================
