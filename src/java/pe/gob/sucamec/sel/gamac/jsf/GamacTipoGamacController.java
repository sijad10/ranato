...
@Named("gamacTipoGamacController")
@SessionScoped
 ...
 * las búsquedas.
 */
public class GamacTipoGamacController implements Serializable {
     ...
     */
    GamacTipoGamac registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<GamacTipoGamac> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<GamacTipoGamac> registrosSeleccionados;
     ...
     * @return
     */
    public List<GamacTipoGamac> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<GamacTipoGamac> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (GamacTipoGamac a : registrosSeleccionados) {
                a.setActivo((short) 0);
                gamacTipoGamacFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (GamacTipoGamac) resultados.getRowData();
            registro.setActivo((short) 1);
            gamacTipoGamacFacade.edit(registro);
     ...
     */
    public GamacTipoGamac getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(GamacTipoGamac registro) {
     ...
     */
    public ListDataModel<GamacTipoGamac> getResultados() {
        return resultados;
    }
     ...
     */
    public List<GamacTipoGamac> getSelectItems() {
        return gamacTipoGamacFacade.findAll();
    }
     ...
     */
    public void buscar() {
        resultados = new ListDataModel(gamacTipoGamacFacade.selectLike(filtro));
    }
    ...
    public void editar() {
        try {
            registro = (GamacTipoGamac) JsfUtil.entidadMayusculas(registro, "");
            gamacTipoGamacFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (GamacTipoGamac) JsfUtil.entidadMayusculas(registro, "");
            gamacTipoGamacFacade.create(registro);
     ...
     */
    public GamacTipoGamac getGamacTipoGamac(Long id) {
        return gamacTipoGamacFacade.find(id);
    }
     ...
     *
     */
    public GamacTipoGamacController() {
        estado = EstadoCrud.BUSCAR;
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "gamacTipoGamacConverter")
    public static class GamacTipoGamacControllerConverterN extends GamacTipoGamacControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = GamacTipoGamac.class)
    public static class GamacTipoGamacControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            GamacTipoGamacController c = (GamacTipoGamacController) JsfUtil.obtenerBean("gamacTipoGamacController", GamacTipoGamacController.class);
            return c.getGamacTipoGamac(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof GamacTipoGamac) {
                GamacTipoGamac o = (GamacTipoGamac) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + GamacTipoGamac.class.getName());
            }
        }
    }
}
