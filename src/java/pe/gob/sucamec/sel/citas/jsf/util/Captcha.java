...
public class Captcha {
     ...
     */
    public boolean ok() {
        return texto.equals(textoInput);
    }

    /**
     * Propiedad de solo escritura donde se guarda el texto de un input para compararlo con el de la imagen
     *
    ...
    /**
     * Genera la imagen del captcha, basicamente selecciona 5 letras al azar, se obviaron la O y el cero para evitar
     * confusiones; dibuja la imagen en gris oscuro con fondo gris, distorsiona la imagen moviendola de izquierda a
     * derecha y genera un grupo de polígonos supersupestos con XOR sobre las letras. La imagen queda almacenada en un
     * array de bytes y el texto en un String.
     */
