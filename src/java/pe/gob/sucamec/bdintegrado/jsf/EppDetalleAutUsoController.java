...
@Named("EppDetalleAutUsoController")
@SessionScoped

/**
 * Clase con EppDetalleAutUsoController instanciada como
 * EppDetalleAutUsoController. Contiene funciones utiles para la
 * entidad EppDetalleAutUso. Esta vinculada a las páginas
 * EppDetalleAutUso/create.xhtml,
 * EppDetalleAutUso/update.xhtml, EppDetalleAutUso/list.xhtml,
 * EppDetalleAutUso/view.xhtml Nota: Las tablas deben tener la
 * estructura de Sucamec para que funcione adecuadamente, revisar si tiene el
 * campo activo y modificar las búsquedas.
 */
public class EppDetalleAutUsoController implements Serializable {
     ...
     */
    EppDetalleAutUso registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<EppDetalleAutUso> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<EppDetalleAutUso> registrosSeleccionados;
     ...
     */
    @EJB
    private pe.gob.sucamec.bdintegrado.bean.EppDetalleAutUsoFacade EppDetalleAutUsoFacade;
     ...
     * @return
     */
    public List<EppDetalleAutUso> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<EppDetalleAutUso> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (EppDetalleAutUso a : registrosSeleccionados) {
                a.setActivo((short) 0);
                EppDetalleAutUsoFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (EppDetalleAutUso) resultados.getRowData();
            registro.setActivo((short) 1);
            EppDetalleAutUsoFacade.edit(registro);
     ...
     */
    public EppDetalleAutUso getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(EppDetalleAutUso registro) {
     ...
     */
    public ListDataModel<EppDetalleAutUso> getResultados() {
        return resultados;
    }
     ...
     */
    public List<EppDetalleAutUso> getSelectItems() {
        return EppDetalleAutUsoFacade.findAll();
    }
     ...
     */
    public void buscar() {
        //resultados = new ListDataModel(EppDetalleAutUsoFacade.selectLike(filtro));
    }
    ...
    public void editar() {
        try {
            registro = (EppDetalleAutUso) JsfUtil.entidadMayusculas(registro, "");
            EppDetalleAutUsoFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (EppDetalleAutUso) JsfUtil.entidadMayusculas(registro, "");
            EppDetalleAutUsoFacade.create(registro);
     ...
     */
    public EppDetalleAutUso getEppDetalleAutUso(Long id) {
        return EppDetalleAutUsoFacade.find(id);
    }
     ...
     *
     */
    public EppDetalleAutUsoController() {
        estado = EstadoCrud.BUSCAR;
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "EppDetalleAutUsoConverter")
    public static class EppDetalleAutUsoControllerConverterN extends EppDetalleAutUsoControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = EppDetalleAutUso.class)
    public static class EppDetalleAutUsoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            EppDetalleAutUsoController c = (EppDetalleAutUsoController) JsfUtil.obtenerBean("EppDetalleAutUsoController", EppDetalleAutUsoController.class);
            return c.getEppDetalleAutUso(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof EppDetalleAutUso) {
                EppDetalleAutUso o = (EppDetalleAutUso) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + EppDetalleAutUso.class.getName());
            }
        }
    }
}
