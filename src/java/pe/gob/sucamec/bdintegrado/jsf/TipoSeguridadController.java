...
@Named("tipoSeguridadController")
@SessionScoped

/**
 * Clase con TipoSeguridadController instanciada como tipoSeguridadController.
 * Contiene funciones utiles para la entidad TipoSeguridad. Esta vinculada a las
 * páginas TipoSeguridad/create.xhtml, TipoSeguridad/update.xhtml,
 * TipoSeguridad/list.xhtml, TipoSeguridad/view.xhtml Nota: Las tablas deben
 * tener la estructura de Sucamec para que funcione adecuadamente, revisar si
 * tiene el campo activo y modificar las búsquedas.
 */
public class TipoSeguridadController implements Serializable {
     ...
     */
    TipoSeguridad registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<TipoSeguridad> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<TipoSeguridad> registrosSeleccionados;
     ...
     */
    @EJB
    private pe.gob.sucamec.bdintegrado.bean.TipoSeguridadFacade tipoSeguridadFacade;
     ...
     * @return
     */
    public List<TipoSeguridad> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<TipoSeguridad> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (TipoSeguridad a : registrosSeleccionados) {
                a.setActivo((short) 0);
                tipoSeguridadFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (TipoSeguridad) resultados.getRowData();
            registro.setActivo((short) 1);
            tipoSeguridadFacade.edit(registro);
     ...
     */
    public TipoSeguridad getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(TipoSeguridad registro) {
     ...
     */
    public ListDataModel<TipoSeguridad> getResultados() {
        return resultados;
    }
     ...
     */
    public List<TipoSeguridad> getSelectItems() {
        return tipoSeguridadFacade.findAll();
    }
     ...
     */
    public void buscar() {
        resultados = new ListDataModel(tipoSeguridadFacade.selectLike(filtro));
    }
    ...
    public void editar() {
        try {
            registro = (TipoSeguridad) JsfUtil.entidadMayusculas(registro, "");
            tipoSeguridadFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (TipoSeguridad) JsfUtil.entidadMayusculas(registro, "");
            tipoSeguridadFacade.create(registro);
     ...
     */
    public TipoSeguridad getTipoSeguridad(Long id) {
        return tipoSeguridadFacade.find(id);
    }
     ...
     *
     */
    public TipoSeguridadController() {
        estado = EstadoCrud.BUSCAR;
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "tipoSeguridadConverter")
    public static class TipoSeguridadControllerConverterN extends TipoSeguridadControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = TipoSeguridad.class)
    public static class TipoSeguridadControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            TipoSeguridadController c = (TipoSeguridadController) JsfUtil.obtenerBean("tipoSeguridadController", TipoSeguridadController.class);
            return c.getTipoSeguridad(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof TipoSeguridad) {
                TipoSeguridad o = (TipoSeguridad) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + TipoSeguridad.class.getName());
            }
        }
    }
}
