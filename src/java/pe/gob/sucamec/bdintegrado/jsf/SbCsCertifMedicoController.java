...
import pe.gob.sucamec.bdintegrado.bean.SbCsCertifMedicoFacade;
...
@Named("sbCsCertifMedicoController")
@SessionScoped

/**
 * Clase con SbCsCertifMedicoController instanciada como
 * sbCsCertifMedicoController. Contiene funciones utiles para la entidad
 * SbCsCertifMedico. Esta vinculada a las páginas SbCsCertifMedico/create.xhtml,
 * SbCsCertifMedico/update.xhtml, SbCsCertifMedico/list.xhtml,
 * SbCsCertifMedico/view.xhtml Nota: Las tablas deben tener la estructura de
 * Sucamec para que funcione adecuadamente, revisar si tiene el campo activo y
 * modificar las búsquedas.
 */
public class SbCsCertifMedicoController implements Serializable {
     ...
     */
    SbCsCertifMedico registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<SbCsCertifMedico> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<SbCsCertifMedico> registrosSeleccionados;
     ...
     */
    @EJB
    private pe.gob.sucamec.bdintegrado.bean.SbCsCertifMedicoFacade sbCsCertifMedicoFacade;
     ...
     * @return
     */
    public List<SbCsCertifMedico> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<SbCsCertifMedico> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (SbCsCertifMedico a : registrosSeleccionados) {
                a.setActivo((short) 0);
                sbCsCertifMedicoFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (SbCsCertifMedico) resultados.getRowData();
            registro.setActivo((short) 1);
            sbCsCertifMedicoFacade.edit(registro);
     ...
     */
    public SbCsCertifMedico getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(SbCsCertifMedico registro) {
     ...
     */
    public ListDataModel<SbCsCertifMedico> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SbCsCertifMedico> getSelectItems() {
        return sbCsCertifMedicoFacade.findAll();
    }
     ...
     */
    public void buscar() {
        resultados = new ListDataModel(sbCsCertifMedicoFacade.selectLike(filtro));
    }
    ...
    public void editar() {
        try {
            registro = (SbCsCertifMedico) JsfUtil.entidadMayusculas(registro, "");
            sbCsCertifMedicoFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SbCsCertifMedico) JsfUtil.entidadMayusculas(registro, "");
            sbCsCertifMedicoFacade.create(registro);
     ...
     */
    public SbCsCertifMedico getSbCsCertifMedico(Long id) {
        return sbCsCertifMedicoFacade.find(id);
    }
     ...
     *
     */
    public SbCsCertifMedicoController() {
        estado = EstadoCrud.BUSCAR;
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "sbCsCertifMedicoConverter")
    public static class SbCsCertifMedicoControllerConverterN extends SbCsCertifMedicoControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = SbCsCertifMedico.class)
    public static class SbCsCertifMedicoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SbCsCertifMedicoController c = (SbCsCertifMedicoController) JsfUtil.obtenerBean("sbCsCertifMedicoController", SbCsCertifMedicoController.class);
            return c.getSbCsCertifMedico(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SbCsCertifMedico) {
                SbCsCertifMedico o = (SbCsCertifMedico) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SbCsCertifMedico.class.getName());
            }
        }
    }
}
