...
@Named("sspPersonaFotoController")
@SessionScoped

/**
 * Clase con SspPersonaFotoController instanciada como sspPersonaFotoController.
 * Contiene funciones utiles para la entidad SspPersonaFoto. Esta vinculada a
 * las páginas SspPersonaFoto/create.xhtml, SspPersonaFoto/update.xhtml,
 * SspPersonaFoto/list.xhtml, SspPersonaFoto/view.xhtml Nota: Las tablas deben
 * tener la estructura de Sucamec para que funcione adecuadamente, revisar si
 * tiene el campo activo y modificar las búsquedas.
 */
public class SspPersonaFotoController implements Serializable {
     ...
     */
    SspPersonaFoto registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<SspPersonaFoto> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<SspPersonaFoto> registrosSeleccionados;
     ...
     */
    @EJB
    private pe.gob.sucamec.bdintegrado.bean.SspPersonaFotoFacade sspPersonaFotoFacade;
     ...
     * @return
     */
    public List<SspPersonaFoto> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<SspPersonaFoto> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (SspPersonaFoto a : registrosSeleccionados) {
                a.setActivo((short) 0);
                sspPersonaFotoFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (SspPersonaFoto) resultados.getRowData();
            registro.setActivo((short) 1);
            sspPersonaFotoFacade.edit(registro);
     ...
     */
    public SspPersonaFoto getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(SspPersonaFoto registro) {
     ...
     */
    public ListDataModel<SspPersonaFoto> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SspPersonaFoto> getSelectItems() {
        return sspPersonaFotoFacade.findAll();
    }
     ...
     */
    public void buscar() {
        resultados = new ListDataModel(sspPersonaFotoFacade.selectLike(filtro));
    }
    ...
    public void editar() {
        try {
            registro = (SspPersonaFoto) JsfUtil.entidadMayusculas(registro, "");
            sspPersonaFotoFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SspPersonaFoto) JsfUtil.entidadMayusculas(registro, "");
            sspPersonaFotoFacade.create(registro);
     ...
     */
    public SspPersonaFoto getSspPersonaFoto(Long id) {
        return sspPersonaFotoFacade.find(id);
    }
     ...
     *
     */
    public SspPersonaFotoController() {
        estado = EstadoCrud.BUSCAR;
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "sspPersonaFotoConverter")
    public static class SspPersonaFotoControllerConverterN extends SspPersonaFotoControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = SspPersonaFoto.class)
    public static class SspPersonaFotoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SspPersonaFotoController c = (SspPersonaFotoController) JsfUtil.obtenerBean("sspPersonaFotoController", SspPersonaFotoController.class);
            return c.getSspPersonaFoto(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SspPersonaFoto) {
                SspPersonaFoto o = (SspPersonaFoto) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SspPersonaFoto.class.getName());
            }
        }
    }
}
