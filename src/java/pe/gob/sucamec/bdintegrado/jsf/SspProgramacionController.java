...
@Named("sspProgramacionController")
@SessionScoped

/**
 * Clase con SspProgramacionController instanciada como
 * sspProgramacionController. Contiene funciones utiles para la entidad
 * SspProgramacion. Esta vinculada a las páginas SspProgramacion/create.xhtml,
 * SspProgramacion/update.xhtml, SspProgramacion/list.xhtml,
 * SspProgramacion/view.xhtml Nota: Las tablas deben tener la estructura de
 * Sucamec para que funcione adecuadamente, revisar si tiene el campo activo y
 * modificar las búsquedas.
 */
public class SspProgramacionController implements Serializable {
     ...
     */
    SspProgramacion registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<SspProgramacion> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<SspProgramacion> registrosSeleccionados;
     ...
     */
    @EJB
    private pe.gob.sucamec.bdintegrado.bean.SspProgramacionFacade sspProgramacionFacade;
     ...
     * @return
     */
    public List<SspProgramacion> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<SspProgramacion> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (SspProgramacion a : registrosSeleccionados) {
                a.setActivo((short) 0);
                sspProgramacionFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (SspProgramacion) resultados.getRowData();
            registro.setActivo((short) 1);
            sspProgramacionFacade.edit(registro);
     ...
     */
    public SspProgramacion getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(SspProgramacion registro) {
     ...
     */
    public ListDataModel<SspProgramacion> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SspProgramacion> getSelectItems() {
        return sspProgramacionFacade.findAll();
    }
     ...
     */
    public void buscar() {
//        resultados = new ListDataModel(sspProgramacionFacade.selectLike(filtro));
    }
    ...
    public void editar() {
        try {
            registro = (SspProgramacion) JsfUtil.entidadMayusculas(registro, "");
            sspProgramacionFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SspProgramacion) JsfUtil.entidadMayusculas(registro, "");
            sspProgramacionFacade.create(registro);
     ...
     */
    public SspProgramacion getSspProgramacion(Long id) {
        return sspProgramacionFacade.find(id);
    }
     ...
     *
     */
    public SspProgramacionController() {
        estado = EstadoCrud.BUSCAR;
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "sspProgramacionConverter")
    public static class SspProgramacionControllerConverterN extends SspProgramacionControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = SspProgramacion.class)
    public static class SspProgramacionControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SspProgramacionController c = (SspProgramacionController) JsfUtil.obtenerBean("sspProgramacionController", SspProgramacionController.class);
            return c.getSspProgramacion(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SspProgramacion) {
                SspProgramacion o = (SspProgramacion) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SspProgramacion.class.getName());
            }
        }
    }
}
