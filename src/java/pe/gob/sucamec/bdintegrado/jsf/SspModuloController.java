...
@Named("sspModuloController")
@SessionScoped

/**
 * Clase con SspModuloController instanciada como sspModuloController. Contiene
 * funciones utiles para la entidad SspModulo. Esta vinculada a las páginas
 * SspModulo/create.xhtml, SspModulo/update.xhtml, SspModulo/list.xhtml,
 * SspModulo/view.xhtml Nota: Las tablas deben tener la estructura de Sucamec
 * para que funcione adecuadamente, revisar si tiene el campo activo y modificar
 * las búsquedas.
 */
public class SspModuloController implements Serializable {
     ...
     */
    ListDataModel<SspModulo> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<SspModulo> registrosSeleccionados;
     ...
     */
    @EJB
    private pe.gob.sucamec.bdintegrado.bean.SspModuloFacade sspModuloFacade;
     ...
     * @return
     */
    public List<SspModulo> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<SspModulo> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (SspModulo a : registrosSeleccionados) {
                a.setActivo((short) 0);
                sspModuloFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (SspModulo) resultados.getRowData();
            registro.setActivo((short) 1);
            sspModuloFacade.edit(registro);
     ...
     */
    public void setRegistro(SspModulo registro) {
     ...
     */
    public ListDataModel<SspModulo> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SspModulo> getSelectItems() {
        return sspModuloFacade.findAll();
    }
     ...
     */
    public void buscar() {
//        resultados = new ListDataModel(sspModuloFacade.selectLike(filtro));
    }
    ...
    public void editar() {
        try {
            registro = (SspModulo) JsfUtil.entidadMayusculas(registro, "");
            sspModuloFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SspModulo) JsfUtil.entidadMayusculas(registro, "");
            sspModuloFacade.create(registro);
     ...
     */
    public SspModulo getSspModulo(Long id) {
        return sspModuloFacade.find(id);
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "sspModuloConverter")
    public static class SspModuloControllerConverterN extends SspModuloControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = SspModulo.class)
    public static class SspModuloControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SspModuloController c = (SspModuloController) JsfUtil.obtenerBean("sspModuloController", SspModuloController.class);
            return c.getSspModulo(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SspModulo) {
                SspModulo o = (SspModulo) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SspModulo.class.getName());
            }
        }
    }
}
