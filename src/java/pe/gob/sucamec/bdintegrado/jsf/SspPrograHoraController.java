...
import pe.gob.sucamec.bdintegrado.bean.SspPrograHoraFacade;
...
@Named("sspPrograHoraController")
@SessionScoped

/**
 * Clase con SspPrograHoraController instanciada como sspPrograHoraController.
 * Contiene funciones utiles para la entidad SspPrograHora. Esta vinculada a las
 * páginas SspPrograHora/create.xhtml, SspPrograHora/update.xhtml,
 * SspPrograHora/list.xhtml, SspPrograHora/view.xhtml Nota: Las tablas deben
 * tener la estructura de Sucamec para que funcione adecuadamente, revisar si
 * tiene el campo activo y modificar las búsquedas.
 */
public class SspPrograHoraController implements Serializable {
     ...
     */
    SspPrograHora registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<SspPrograHora> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<SspPrograHora> registrosSeleccionados;
     ...
     */
    @EJB
    private pe.gob.sucamec.bdintegrado.bean.SspPrograHoraFacade sspPrograHoraFacade;
     ...
     * @return
     */
    public List<SspPrograHora> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<SspPrograHora> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (SspPrograHora a : registrosSeleccionados) {
                a.setActivo((short) 0);
                sspPrograHoraFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (SspPrograHora) resultados.getRowData();
            registro.setActivo((short) 1);
            sspPrograHoraFacade.edit(registro);
     ...
     */
    public SspPrograHora getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(SspPrograHora registro) {
     ...
     */
    public ListDataModel<SspPrograHora> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SspPrograHora> getSelectItems() {
        return sspPrograHoraFacade.findAll();
    }
     ...
     */
    public void buscar() {
        resultados = new ListDataModel(sspPrograHoraFacade.selectLike(filtro));
    }
    ...
    public void editar() {
        try {
            registro = (SspPrograHora) JsfUtil.entidadMayusculas(registro, "");
            sspPrograHoraFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SspPrograHora) JsfUtil.entidadMayusculas(registro, "");
            sspPrograHoraFacade.create(registro);
     ...
     */
    public SspPrograHora getSspPrograHora(Long id) {
        return sspPrograHoraFacade.find(id);
    }
     ...
     *
     */
    public SspPrograHoraController() {
        estado = EstadoCrud.BUSCAR;
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "sspPrograHoraConverter")
    public static class SspPrograHoraControllerConverterN extends SspPrograHoraControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = SspPrograHora.class)
    public static class SspPrograHoraControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SspPrograHoraController c = (SspPrograHoraController) JsfUtil.obtenerBean("sspPrograHoraController", SspPrograHoraController.class);
            return c.getSspPrograHora(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SspPrograHora) {
                SspPrograHora o = (SspPrograHora) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SspPrograHora.class.getName());
            }
        }
    }
}
