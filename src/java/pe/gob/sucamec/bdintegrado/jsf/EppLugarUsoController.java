...
import pe.gob.sucamec.bdintegrado.bean.EppLugarUsoFacade;
...
@Named("eppLugarUsoController")
@SessionScoped

/**
 * Clase con EppLugarUsoController instanciada como eppLugarUsoController.
 * Contiene funciones utiles para la entidad EppLugarUso. Esta vinculada a las
 * páginas EppLugarUso/create.xhtml, EppLugarUso/update.xhtml,
 * EppLugarUso/list.xhtml, EppLugarUso/view.xhtml Nota: Las tablas deben tener
 * la estructura de Sucamec para que funcione adecuadamente, revisar si tiene el
 * campo activo y modificar las búsquedas.
 */
public class EppLugarUsoController implements Serializable {
     ...
     */
    EppLugarUso registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<EppLugarUso> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<EppLugarUso> registrosSeleccionados;
     ...
     */
    @EJB
    private pe.gob.sucamec.bdintegrado.bean.EppLugarUsoFacade eppLugarUsoFacade;
     ...
     * @return
     */
    public List<EppLugarUso> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<EppLugarUso> a) {
     ...
     */
    public EppLugarUso getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(EppLugarUso registro) {
     ...
     */
    public ListDataModel<EppLugarUso> getResultados() {
        return resultados;
    }
     ...
     */
    public List<EppLugarUso> getSelectItems() {
        return eppLugarUsoFacade.findAll();
    }
     ...
     */
    public EppLugarUso getEppLugarUso(Long id) {
        return eppLugarUsoFacade.find(id);
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "eppLugarUsoConverter")
    public static class EppLugarUsoControllerConverterN extends EppLugarUsoControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = EppLugarUso.class)
    public static class EppLugarUsoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            EppLugarUsoController c = (EppLugarUsoController) JsfUtil.obtenerBean("eppLugarUsoController", EppLugarUsoController.class);
            return c.getEppLugarUso(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof EppLugarUso) {
                EppLugarUso o = (EppLugarUso) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + EppLugarUso.class.getName());
            }
        }
    }
}
