...
@Named("sbRecibosController")
@SessionScoped

/**
 * Clase con SbRecibosController instanciada como sbRecibosController. Contiene
 * funciones utiles para la entidad SbRecibos. Esta vinculada a las páginas
 * SbRecibos/create.xhtml, SbRecibos/update.xhtml, SbRecibos/list.xhtml,
 * SbRecibos/view.xhtml Nota: Las tablas deben tener la estructura de Sucamec
 * para que funcione adecuadamente, revisar si tiene el campo activo y modificar
 * las búsquedas.
 */
public class SbRecibosController implements Serializable {
     ...
     */
    ListDataModel<SbRecibos> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<SbRecibos> registrosSeleccionados;
     ...
     * @return
     */
    public List<SbRecibos> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<SbRecibos> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (SbRecibos a : registrosSeleccionados) {
                a.setActivo((short) 0);
                sbRecibosFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (SbRecibos) resultados.getRowData();
            registro.setActivo((short) 1);
            sbRecibosFacade.edit(registro);
     ...
     */
    public void setRegistro(SbRecibos registro) {
     ...
     */
    public ListDataModel<SbRecibos> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SbRecibos> getSelectItems() {
        return sbRecibosFacade.findAll();
    }
     ...
     */
    public void buscar() {
       // resultados = new ListDataModel(sbRecibosFacade.selectLike(filtro));
    }
    ...
    public void editar() {
        try {
            registro = (SbRecibos) JsfUtil.entidadMayusculas(registro, "");
            sbRecibosFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SbRecibos) JsfUtil.entidadMayusculas(registro, "");
            sbRecibosFacade.create(registro);
     ...
     */
    public SbRecibos getSbRecibos(Long id) {
        return sbRecibosFacade.find(id);
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "sbRecibosConverter")
    public static class SbRecibosControllerConverterN extends SbRecibosControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = SbRecibos.class)
    public static class SbRecibosControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SbRecibosController c = (SbRecibosController) JsfUtil.obtenerBean("sbRecibosController", SbRecibosController.class);
            return c.getSbRecibos(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SbRecibos) {
                SbRecibos o = (SbRecibos) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SbRecibos.class.getName());
            }
        }
    }
}
