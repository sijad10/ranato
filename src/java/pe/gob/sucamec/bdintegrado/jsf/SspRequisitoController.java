...
@Named("sspRequisitoController")
@SessionScoped

/**
 * Clase con SspRequisitoController instanciada como sspRequisitoController.
 * Contiene funciones utiles para la entidad SspRequisito. Esta vinculada a las
 * páginas SspRequisito/create.xhtml, SspRequisito/update.xhtml,
 * SspRequisito/list.xhtml, SspRequisito/view.xhtml Nota: Las tablas deben tener
 * la estructura de Sucamec para que funcione adecuadamente, revisar si tiene el
 * campo activo y modificar las búsquedas.
 */
public class SspRequisitoController implements Serializable {
     ...
     */
    SspRequisito registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<SspRequisito> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<SspRequisito> registrosSeleccionados;
     ...
     * @return
     */
    public List<SspRequisito> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<SspRequisito> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (SspRequisito a : registrosSeleccionados) {
                a.setActivo((short) 0);
                ejbSspRequisitoFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (SspRequisito) resultados.getRowData();
            registro.setActivo((short) 1);
            ejbSspRequisitoFacade.edit(registro);
     ...
     */
    public SspRequisito getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(SspRequisito registro) {
     ...
     */
    public ListDataModel<SspRequisito> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SspRequisito> getSelectItems() {
        return ejbSspRequisitoFacade.findAll();
    }
     ...
     */
    public void buscar() {
//        resultados = new ListDataModel(ejbSspRequisitoFacade.selectLike(filtro));
    }
    ...
    public void editar() {
        try {
            registro = (SspRequisito) JsfUtil.entidadMayusculas(registro, "");
            ejbSspRequisitoFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SspRequisito) JsfUtil.entidadMayusculas(registro, "");
            ejbSspRequisitoFacade.create(registro);
     ...
     */
    public SspRequisito getSspRequisito(Long id) {
        return ejbSspRequisitoFacade.find(id);
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "sspRequisitoConverter")
    public static class SspRequisitoControllerConverterN extends SspRequisitoControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = SspRequisito.class)
    public static class SspRequisitoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SspRequisitoController c = (SspRequisitoController) JsfUtil.obtenerBean("sspRequisitoController", SspRequisitoController.class);
            return c.getSspRequisito(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SspRequisito) {
                SspRequisito o = (SspRequisito) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SspRequisito.class.getName());
            }
        }
    }
}
