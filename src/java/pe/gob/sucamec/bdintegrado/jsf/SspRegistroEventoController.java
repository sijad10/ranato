...
@Named("sspRegistroEventoController")
@SessionScoped

/**
 * Clase con SspRegistroEventoController instanciada como
 * sspRegistroEventoController. Contiene funciones utiles para la entidad
 * SspRegistroEvento. Esta vinculada a las páginas
 * SspRegistroEvento/create.xhtml, SspRegistroEvento/update.xhtml,
 * SspRegistroEvento/list.xhtml, SspRegistroEvento/view.xhtml Nota: Las tablas
 ...
 */
public class SspRegistroEventoController implements Serializable {
     ...
     */
    SspRegistroEvento registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<SspRegistroEvento> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<SspRegistroEvento> registrosSeleccionados;
     ...
     * @return
     */
    public List<SspRegistroEvento> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<SspRegistroEvento> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (SspRegistroEvento a : registrosSeleccionados) {
                a.setActivo((short) 0);
                ejbSspRegistroEventoFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (SspRegistroEvento) resultados.getRowData();
            registro.setActivo((short) 1);
            ejbSspRegistroEventoFacade.edit(registro);
     ...
     */
    public SspRegistroEvento getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(SspRegistroEvento registro) {
     ...
     */
    public ListDataModel<SspRegistroEvento> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SspRegistroEvento> getSelectItems() {
        return ejbSspRegistroEventoFacade.findAll();
    }
     ...
     */
    public void buscar() {
//        resultados = new ListDataModel(ejbSspRegistroEventoFacade.selectLike(filtro));
    }
    ...
    public void mostrarCrear() {
        ...
        registro = new SspRegistroEvento();
        registro.setActivo((short) 1);
    }
    ...
    public void editar() {
        try {
            registro = (SspRegistroEvento) JsfUtil.entidadMayusculas(registro, "");
            ejbSspRegistroEventoFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SspRegistroEvento) JsfUtil.entidadMayusculas(registro, "");
            ejbSspRegistroEventoFacade.create(registro);
     ...
     */
    public SspRegistroEvento getSspRegistroEvento(Long id) {
        return ejbSspRegistroEventoFacade.find(id);
    }
     ...
     *
     */
    public SspRegistroEventoController() {
        estado = EstadoCrud.BUSCAR;
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "sspRegistroEventoConverter")
    public static class SspRegistroEventoControllerConverterN extends SspRegistroEventoControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = SspRegistroEvento.class)
    public static class SspRegistroEventoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SspRegistroEventoController c = (SspRegistroEventoController) JsfUtil.obtenerBean("sspRegistroEventoController", SspRegistroEventoController.class);
            return c.getSspRegistroEvento(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SspRegistroEvento) {
                SspRegistroEvento o = (SspRegistroEvento) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SspRegistroEvento.class.getName());
            }
        }
    }
}
