...
@Named("sspInstructorController")
@SessionScoped

/**
 * Clase con SspInstructorController instanciada como sspInstructorController.
 * Contiene funciones utiles para la entidad SspInstructor. Esta vinculada a las
 * páginas SspInstructor/create.xhtml, SspInstructor/update.xhtml,
 * SspInstructor/list.xhtml, SspInstructor/view.xhtml Nota: Las tablas deben
 * tener la estructura de Sucamec para que funcione adecuadamente, revisar si
 * tiene el campo activo y modificar las búsquedas.
 */
public class SspInstructorController implements Serializable {
     ...
     */
    SspInstructor registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<SspInstructor> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<SspInstructor> registrosSeleccionados;
     ...
     */
    @EJB
    private pe.gob.sucamec.bdintegrado.bean.SspInstructorFacade sspInstructorFacade;
     ...
     * @return
     */
    public List<SspInstructor> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<SspInstructor> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (SspInstructor a : registrosSeleccionados) {
                a.setActivo((short) 0);
                sspInstructorFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (SspInstructor) resultados.getRowData();
            registro.setActivo((short) 1);
            sspInstructorFacade.edit(registro);
     ...
     */
    public SspInstructor getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(SspInstructor registro) {
     ...
     */
    public ListDataModel<SspInstructor> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SspInstructor> getSelectItems() {
        return sspInstructorFacade.findAll();
    }
     ...
     */
    public void buscar() {
//        resultados = new ListDataModel(sspInstructorFacade.selectLike(filtro));
    }
    ...
    public void editar() {
        try {
            registro = (SspInstructor) JsfUtil.entidadMayusculas(registro, "");
            sspInstructorFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SspInstructor) JsfUtil.entidadMayusculas(registro, "");
            sspInstructorFacade.create(registro);
     ...
     */
    public SspInstructor getSspInstructor(Long id) {
        return sspInstructorFacade.find(id);
    }
     ...
     *
     */
    public SspInstructorController() {
        estado = EstadoCrud.BUSCAR;
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "sspInstructorConverter")
    public static class SspInstructorControllerConverterN extends SspInstructorControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = SspInstructor.class)
    public static class SspInstructorControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SspInstructorController c = (SspInstructorController) JsfUtil.obtenerBean("sspInstructorController", SspInstructorController.class);
            return c.getSspInstructor(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SspInstructor) {
                SspInstructor o = (SspInstructor) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SspInstructor.class.getName());
            }
        }
    }
}
