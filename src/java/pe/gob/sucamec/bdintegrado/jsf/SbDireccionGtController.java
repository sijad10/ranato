 ...
 */
public class SbDireccionGtController implements Serializable {
     ...
     */
    SbDireccionGt registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<SbDireccionGt> resultados = null;

    /**
     * Facade de la clase del controller, se pueden agregar más facades de acuerdo a la implementación.
     */
    @EJB
    private SbDireccionFacadeGt sbDireccionFacade;
    ...
    public void activar() {
        try {
            registro = (SbDireccionGt) resultados.getRowData();
            registro.setActivo((short) 1);
            sbDireccionFacade.edit(registro);
     ...
     */
    public SbDireccionGt getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(SbDireccionGt registro) {
     ...
     */
    public ListDataModel<SbDireccionGt> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SbDireccionGt> getSelectItems() {
        return sbDireccionFacade.findAll();
    }
    ...
    public void buscar() {
        ...
        resultados = new ListDataModel(sbDireccionFacade.findAll());
    }
    ...
    public void editar() {
        try {
            registro = (SbDireccionGt) JsfUtil.entidadMayusculas(registro, "");
            sbDireccionFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SbDireccionGt) JsfUtil.entidadMayusculas(registro, "");
            sbDireccionFacade.create(registro);
     ...
     *
     */
    public SbDireccionGtController() {
        estado = EstadoCrud.BUSCAR;
    }
     ...
     */
    public SbDireccionGt getSbDireccion(Long id) {
        return sbDireccionFacade.find(id);
    }
    
    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = SbDireccionGt.class)
    public static class SbDireccionControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SbDireccionGtController c = (SbDireccionGtController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "sbDireccionGtController");
            return c.getSbDireccion(getKey(value));
...
//            return c.getSbDireccion(Long.valueOf(value));
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SbDireccionGt) {
                SbDireccionGt o = (SbDireccionGt) object;
                String r="";
                if(o.getId()!=null){
                    r=o.getId().toString();
                }
                ...
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SbDireccionGt.class.getName());
            }
        }
    }
}
