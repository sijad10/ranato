...
@Named("sspCursoEventoController")
@SessionScoped

/**
 * Clase con SspCursoEventoController instanciada como sspCursoEventoController.
 * Contiene funciones utiles para la entidad SspCursoEvento. Esta vinculada a
 * las páginas SspCursoEvento/create.xhtml, SspCursoEvento/update.xhtml,
 * SspCursoEvento/list.xhtml, SspCursoEvento/view.xhtml Nota: Las tablas deben
 * tener la estructura de Sucamec para que funcione adecuadamente, revisar si
 * tiene el campo activo y modificar las búsquedas.
 */
public class SspCursoEventoController implements Serializable {
     ...
     */
    SspCursoEvento registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<SspCursoEvento> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<SspCursoEvento> registrosSeleccionados;
     ...
     */
    @EJB
    private pe.gob.sucamec.bdintegrado.bean.SspCursoEventoFacade sspCursoEventoFacade;
     ...
     * @return
     */
    public List<SspCursoEvento> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<SspCursoEvento> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (SspCursoEvento a : registrosSeleccionados) {
                a.setActivo((short) 0);
                sspCursoEventoFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (SspCursoEvento) resultados.getRowData();
            registro.setActivo((short) 1);
            sspCursoEventoFacade.edit(registro);
     ...
     */
    public SspCursoEvento getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(SspCursoEvento registro) {
     ...
     */
    public ListDataModel<SspCursoEvento> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SspCursoEvento> getSelectItems() {
        return sspCursoEventoFacade.findAll();
    }
     ...
     */
    public void buscar() {
//        resultados = new ListDataModel(sspCursoEventoFacade.selectLike(filtro));
    }
    ...
    public void editar() {
        try {
            registro = (SspCursoEvento) JsfUtil.entidadMayusculas(registro, "");
            sspCursoEventoFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SspCursoEvento) JsfUtil.entidadMayusculas(registro, "");
            sspCursoEventoFacade.create(registro);
     ...
     */
    public SspCursoEvento getSspCursoEvento(Long id) {
        return sspCursoEventoFacade.find(id);
    }
     ...
     *
     */
    public SspCursoEventoController() {
        estado = EstadoCrud.BUSCAR;
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "sspCursoEventoConverter")
    public static class SspCursoEventoControllerConverterN extends SspCursoEventoControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = SspCursoEvento.class)
    public static class SspCursoEventoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SspCursoEventoController c = (SspCursoEventoController) JsfUtil.obtenerBean("sspCursoEventoController", SspCursoEventoController.class);
            return c.getSspCursoEvento(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SspCursoEvento) {
                SspCursoEvento o = (SspCursoEvento) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SspCursoEvento.class.getName());
            }
        }
    }
}
