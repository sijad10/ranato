...
@Named("sspAlumnoCursoController")
@SessionScoped

/**
 * Clase con SspAlumnoCursoController instanciada como sspAlumnoCursoController.
 * Contiene funciones utiles para la entidad SspAlumnoCurso. Esta vinculada a
 * las páginas SspAlumnoCurso/create.xhtml, SspAlumnoCurso/update.xhtml,
 * SspAlumnoCurso/list.xhtml, SspAlumnoCurso/view.xhtml Nota: Las tablas deben
 * tener la estructura de Sucamec para que funcione adecuadamente, revisar si
 * tiene el campo activo y modificar las búsquedas.
 */
public class SspAlumnoCursoController implements Serializable {
     ...
     */
    SspAlumnoCurso registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<SspAlumnoCurso> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<SspAlumnoCurso> registrosSeleccionados;
     ...
     */
    @EJB
    private pe.gob.sucamec.bdintegrado.bean.SspAlumnoCursoFacade sspAlumnoCursoFacade;
     ...
     * @return
     */
    public List<SspAlumnoCurso> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<SspAlumnoCurso> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (SspAlumnoCurso a : registrosSeleccionados) {
                a.setActivo((short) 0);
                sspAlumnoCursoFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (SspAlumnoCurso) resultados.getRowData();
            registro.setActivo((short) 1);
            sspAlumnoCursoFacade.edit(registro);
     ...
     */
    public SspAlumnoCurso getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(SspAlumnoCurso registro) {
     ...
     */
    public ListDataModel<SspAlumnoCurso> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SspAlumnoCurso> getSelectItems() {
        return sspAlumnoCursoFacade.findAll();
    }
     ...
     */
    public void buscar() {
        resultados = new ListDataModel(sspAlumnoCursoFacade.selectLike(filtro));
    }
    ...
    public void editar() {
        try {
            registro = (SspAlumnoCurso) JsfUtil.entidadMayusculas(registro, "");
            sspAlumnoCursoFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SspAlumnoCurso) JsfUtil.entidadMayusculas(registro, "");
            sspAlumnoCursoFacade.create(registro);
     ...
     */
    public SspAlumnoCurso getSspAlumnoCurso(Long id) {
        return sspAlumnoCursoFacade.find(id);
    }
     ...
     *
     */
    public SspAlumnoCursoController() {
        estado = EstadoCrud.BUSCAR;
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "sspAlumnoCursoConverter")
    public static class SspAlumnoCursoControllerConverterN extends SspAlumnoCursoControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = SspAlumnoCurso.class)
    public static class SspAlumnoCursoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SspAlumnoCursoController c = (SspAlumnoCursoController) JsfUtil.obtenerBean("sspAlumnoCursoController", SspAlumnoCursoController.class);
            return c.getSspAlumnoCurso(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SspAlumnoCurso) {
                SspAlumnoCurso o = (SspAlumnoCurso) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SspAlumnoCurso.class.getName());
            }
        }
    }
}
