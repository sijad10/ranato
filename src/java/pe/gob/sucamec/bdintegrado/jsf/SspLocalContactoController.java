...
@Named("sspLocalContactoController")
@SessionScoped

/**
 * Clase con SspLocalContactoController instanciada como
 * sspLocalContactoController. Contiene funciones utiles para la entidad
 * SspLocalContacto. Esta vinculada a las páginas SspLocalContacto/create.xhtml,
 * SspLocalContacto/update.xhtml, SspLocalContacto/list.xhtml,
 * SspLocalContacto/view.xhtml Nota: Las tablas deben tener la estructura de
 * Sucamec para que funcione adecuadamente, revisar si tiene el campo activo y
 * modificar las búsquedas.
 */
public class SspLocalContactoController implements Serializable {
     ...
     */
    SspLocalContacto registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<SspLocalContacto> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<SspLocalContacto> registrosSeleccionados;
     ...
     */
    @EJB
    private pe.gob.sucamec.bdintegrado.bean.SspLocalContactoFacade sspLocalContactoFacade;
     ...
     * @return
     */
    public List<SspLocalContacto> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<SspLocalContacto> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (SspLocalContacto a : registrosSeleccionados) {
                a.setActivo((short) 0);
                sspLocalContactoFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (SspLocalContacto) resultados.getRowData();
            registro.setActivo((short) 1);
            sspLocalContactoFacade.edit(registro);
     ...
     */
    public SspLocalContacto getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(SspLocalContacto registro) {
     ...
     */
    public ListDataModel<SspLocalContacto> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SspLocalContacto> getSelectItems() {
        return sspLocalContactoFacade.findAll();
    }
     ...
     */
    public void buscar() {
//        resultados = new ListDataModel(sspLocalContactoFacade.selectLike(filtro));
    }
    ...
    public void editar() {
        try {
            registro = (SspLocalContacto) JsfUtil.entidadMayusculas(registro, "");
            sspLocalContactoFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SspLocalContacto) JsfUtil.entidadMayusculas(registro, "");
            sspLocalContactoFacade.create(registro);
     ...
     */
    public SspLocalContacto getSspLocalContacto(Long id) {
        return sspLocalContactoFacade.find(id);
    }
     ...
     *
     */
    public SspLocalContactoController() {
        estado = EstadoCrud.BUSCAR;
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "sspLocalContactoConverter")
    public static class SspLocalContactoControllerConverterN extends SspLocalContactoControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = SspLocalContacto.class)
    public static class SspLocalContactoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SspLocalContactoController c = (SspLocalContactoController) JsfUtil.obtenerBean("sspLocalContactoController", SspLocalContactoController.class);
            return c.getSspLocalContacto(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SspLocalContacto) {
                SspLocalContacto o = (SspLocalContacto) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SspLocalContacto.class.getName());
            }
        }
    }
}
