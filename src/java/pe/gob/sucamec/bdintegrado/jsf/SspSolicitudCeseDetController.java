...
@Named("sspSolicitudCeseDetController")
@SessionScoped

/**
 * Clase con SspSolicitudCeseDetController instanciada como
 * sspSolicitudCeseDetController. Contiene funciones utiles para la entidad
 * SspSolicitudCeseDet. Esta vinculada a las páginas
 * SspSolicitudCeseDet/create.xhtml, SspSolicitudCeseDet/update.xhtml,
 * SspSolicitudCeseDet/list.xhtml, SspSolicitudCeseDet/view.xhtml Nota: Las
 ...
 */
public class SspSolicitudCeseDetController implements Serializable {
     ...
     */
    SspSolicitudCeseDet registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<SspSolicitudCeseDet> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<SspSolicitudCeseDet> registrosSeleccionados;
     ...
     */
    @EJB
    private pe.gob.sucamec.bdintegrado.bean.SspSolicitudCeseDetFacade sspSolicitudCeseDetFacade;
     ...
     * @return
     */
    public List<SspSolicitudCeseDet> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<SspSolicitudCeseDet> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (SspSolicitudCeseDet a : registrosSeleccionados) {
                a.setActivo((short) 0);
                sspSolicitudCeseDetFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (SspSolicitudCeseDet) resultados.getRowData();
            registro.setActivo((short) 1);
            sspSolicitudCeseDetFacade.edit(registro);
     ...
     */
    public SspSolicitudCeseDet getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(SspSolicitudCeseDet registro) {
     ...
     */
    public ListDataModel<SspSolicitudCeseDet> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SspSolicitudCeseDet> getSelectItems() {
        return sspSolicitudCeseDetFacade.findAll();
    }
     ...
     */
    public void buscar() {
        resultados = new ListDataModel(sspSolicitudCeseDetFacade.selectLike(filtro));
    }
    ...
    public void mostrarCrear() {
        ...
        registro = new SspSolicitudCeseDet();
        registro.setActivo((short) 1);
    }
    ...
    public void editar() {
        try {
            registro = (SspSolicitudCeseDet) JsfUtil.entidadMayusculas(registro, "");
            sspSolicitudCeseDetFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SspSolicitudCeseDet) JsfUtil.entidadMayusculas(registro, "");
            sspSolicitudCeseDetFacade.create(registro);
     ...
     */
    public SspSolicitudCeseDet getSspSolicitudCeseDet(Long id) {
        return sspSolicitudCeseDetFacade.find(id);
    }
     ...
     *
     */
    public SspSolicitudCeseDetController() {
        estado = EstadoCrud.BUSCAR;
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "sspSolicitudCeseDetConverter")
    public static class SspSolicitudCeseDetControllerConverterN extends SspSolicitudCeseDetControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = SspSolicitudCeseDet.class)
    public static class SspSolicitudCeseDetControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SspSolicitudCeseDetController c = (SspSolicitudCeseDetController) JsfUtil.obtenerBean("sspSolicitudCeseDetController", SspSolicitudCeseDetController.class);
            return c.getSspSolicitudCeseDet(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SspSolicitudCeseDet) {
                SspSolicitudCeseDet o = (SspSolicitudCeseDet) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SspSolicitudCeseDet.class.getName());
            }
        }
    }
}
