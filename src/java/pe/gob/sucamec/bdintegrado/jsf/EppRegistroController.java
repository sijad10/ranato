...
import pe.gob.sucamec.bdintegrado.bean.EppRegistroFacade;
...
@Named("eppRegistroController")
@SessionScoped

/**
 * Clase con EppRegistroController instanciada como eppRegistroController.
 * Contiene funciones utiles para la entidad EppRegistro. Esta vinculada a las
 * páginas EppRegistro/create.xhtml, EppRegistro/update.xhtml,
 * EppRegistro/list.xhtml, EppRegistro/view.xhtml Nota: Las tablas deben tener
 * la estructura de Sucamec para que funcione adecuadamente, revisar si tiene el
 * campo activo y modificar las búsquedas.
 */
public class EppRegistroController implements Serializable {
    ...
    public void activar() {
        try {
            ...
            registro.setActivo((short) 1);
            eppRegistroFacade.edit(registro);
    ...
    public List<EppRegistro> getSelectItems() {
        return eppRegistroFacade.findAll();
    }
     ...
     */
    public void buscar() {
        //resultados = new ListDataModel(eppRegistroFacade.selectLike(filtro));
    }
    ...
    public void crear() {
        try {
            registro = (EppRegistro) JsfUtil.entidadMayusculas(registro, "");
            eppRegistroFacade.create(registro);
     ...
     */
    public EppRegistro getEppRegistro(Long id) {
        return eppRegistroFacade.find(id);
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "eppRegistroConverter")
    public static class EppRegistroControllerConverterN extends EppRegistroControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = EppRegistro.class)
    public static class EppRegistroControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            EppRegistroController c = (EppRegistroController) JsfUtil.obtenerBean("eppRegistroController", EppRegistroController.class);
            Long x = 0L;
            try {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof EppRegistro) {
                EppRegistro o = (EppRegistro) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + EppRegistro.class.getName());
            }
        }
    }
}
