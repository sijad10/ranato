...
@Named("sspLocalController")
@SessionScoped

/**
 * Clase con SspLocalController instanciada como sspLocalController. Contiene
 * funciones utiles para la entidad SspLocal. Esta vinculada a las páginas
 * SspLocal/create.xhtml, SspLocal/update.xhtml, SspLocal/list.xhtml,
 * SspLocal/view.xhtml Nota: Las tablas deben tener la estructura de Sucamec
 * para que funcione adecuadamente, revisar si tiene el campo activo y modificar
 * las búsquedas.
 */
public class SspLocalController implements Serializable {
     ...
     */
    ListDataModel<SspLocal> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<SspLocal> registrosSeleccionados;
     ...
     */
    @EJB
    private pe.gob.sucamec.bdintegrado.bean.SspLocalFacade sspLocalFacade;
     ...
     * @return
     */
    public List<SspLocal> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<SspLocal> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (SspLocal a : registrosSeleccionados) {
                a.setActivo((short) 0);
                sspLocalFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (SspLocal) resultados.getRowData();
            registro.setActivo((short) 1);
            sspLocalFacade.edit(registro);
     ...
     */
    public void setRegistro(SspLocal registro) {
     ...
     */
    public ListDataModel<SspLocal> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SspLocal> getSelectItems() {
        return sspLocalFacade.findAll();
    }
     ...
     */
    public void buscar() {
//        resultados = new ListDataModel(sspLocalFacade.selectLike(filtro));
    }
    ...
    public void editar() {
        try {
            registro = (SspLocal) JsfUtil.entidadMayusculas(registro, "");
            sspLocalFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SspLocal) JsfUtil.entidadMayusculas(registro, "");
            sspLocalFacade.create(registro);
     ...
     */
    public SspLocal getSspLocal(Long id) {
        return sspLocalFacade.find(id);
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "sspLocalConverter")
    public static class SspLocalControllerConverterN extends SspLocalControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = SspLocal.class)
    public static class SspLocalControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SspLocalController c = (SspLocalController) JsfUtil.obtenerBean("sspLocalController", SspLocalController.class);
            return c.getSspLocal(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SspLocal) {
                SspLocal o = (SspLocal) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SspLocal.class.getName());
            }
        }
    }
}
