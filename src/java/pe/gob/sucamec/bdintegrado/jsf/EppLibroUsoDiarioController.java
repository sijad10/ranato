...
import pe.gob.sucamec.bdintegrado.bean.EppLibroUsoDiarioFacade;
...
@Named("eppLibroUsoDiarioController")
@SessionScoped

/**
 * Clase con EppLibroUsoDiarioController instanciada como
 * eppLibroUsoDiarioController. Contiene funciones utiles para la entidad
 * EppLibroUsoDiario. Esta vinculada a las páginas
 * EppLibroUsoDiario/create.xhtml, EppLibroUsoDiario/update.xhtml,
 * EppLibroUsoDiario/list.xhtml, EppLibroUsoDiario/view.xhtml Nota: Las tablas
 ...
 */
public class EppLibroUsoDiarioController implements Serializable {
     ...
     */
    EppLibroUsoDiario registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<EppLibroUsoDiario> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<EppLibroUsoDiario> registrosSeleccionados;
     ...
     * @return
     */
    public List<EppLibroUsoDiario> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<EppLibroUsoDiario> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (EppLibroUsoDiario a : registrosSeleccionados) {
                a.setActivo((short) 0);
                eppLibroUsoDiarioFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (EppLibroUsoDiario) resultados.getRowData();
            registro.setActivo((short) 1);
            eppLibroUsoDiarioFacade.edit(registro);
     ...
     */
    public EppLibroUsoDiario getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(EppLibroUsoDiario registro) {
     ...
     */
    public ListDataModel<EppLibroUsoDiario> getResultados() {
        return resultados;
    }
     ...
     */
    public List<EppLibroUsoDiario> getSelectItems() {
        return eppLibroUsoDiarioFacade.findAll();
    }
     ...
     */
    public void buscar() {
        //resultados = new ListDataModel(eppLibroUsoDiarioFacade.selectLike(filtro));
    }
    ...
    public void mostrarCrear() {
        ...
        registro = new EppLibroUsoDiario();
        registro.setActivo((short) 1);
    }
    ...
    public void editar() {
        try {
            registro = (EppLibroUsoDiario) JsfUtil.entidadMayusculas(registro, "");
            eppLibroUsoDiarioFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (EppLibroUsoDiario) JsfUtil.entidadMayusculas(registro, "");
            eppLibroUsoDiarioFacade.create(registro);
     ...
     */
    public EppLibroUsoDiario getEppLibroUsoDiario(Long id) {
        return eppLibroUsoDiarioFacade.find(id);
    }
     ...
     *
     */
    public EppLibroUsoDiarioController() {
        estado = EstadoCrud.BUSCAR;
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "eppLibroUsoDiarioConverter")
    public static class EppLibroUsoDiarioControllerConverterN extends EppLibroUsoDiarioControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = EppLibroUsoDiario.class)
    public static class EppLibroUsoDiarioControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            EppLibroUsoDiarioController c = (EppLibroUsoDiarioController) JsfUtil.obtenerBean("eppLibroUsoDiarioController", EppLibroUsoDiarioController.class);
            return c.getEppLibroUsoDiario(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof EppLibroUsoDiario) {
                EppLibroUsoDiario o = (EppLibroUsoDiario) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + EppLibroUsoDiario.class.getName());
            }
        }
    }
}
