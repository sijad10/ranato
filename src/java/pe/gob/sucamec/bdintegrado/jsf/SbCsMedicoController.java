...
@Named("sbCsMedicoController")
@SessionScoped

/**
 * Clase con SbCsMedicoController instanciada como sbCsMedicoController.
 * Contiene funciones utiles para la entidad SbCsMedico. Esta vinculada a las
 * páginas SbCsMedico/create.xhtml, SbCsMedico/update.xhtml,
 * SbCsMedico/list.xhtml, SbCsMedico/view.xhtml Nota: Las tablas deben tener la
 * estructura de Sucamec para que funcione adecuadamente, revisar si tiene el
 * campo activo y modificar las búsquedas.
 */
public class SbCsMedicoController implements Serializable {
     ...
     */
    ListDataModel<SbCsMedico> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<SbCsMedico> registrosSeleccionados;
     ...
     * @return
     */
    public List<SbCsMedico> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<SbCsMedico> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (SbCsMedico a : registrosSeleccionados) {
                a.setActivo((short) 0);
                ejbSbCsMedicoFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (SbCsMedico) resultados.getRowData();
            registro.setActivo((short) 1);
            ejbSbCsMedicoFacade.edit(registro);
     ...
     */
    public void setRegistro(SbCsMedico registro) {
     ...
     */
    public ListDataModel<SbCsMedico> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SbCsMedico> getSelectItems() {
        return ejbSbCsMedicoFacade.findAll();
    }
     ...
     */
    public void buscar() {
        resultados = new ListDataModel(ejbSbCsMedicoFacade.selectLike(filtro));
    }
    ...
    public void editar() {
        try {
            registro = (SbCsMedico) JsfUtil.entidadMayusculas(registro, "");
            ejbSbCsMedicoFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SbCsMedico) JsfUtil.entidadMayusculas(registro, "");
            ejbSbCsMedicoFacade.create(registro);
     ...
     */
    public SbCsMedico getSbCsMedico(Long id) {
        return ejbSbCsMedicoFacade.find(id);
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "sbCsMedicoConverter")
    public static class SbCsMedicoControllerConverterN extends SbCsMedicoControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = SbCsMedico.class)
    public static class SbCsMedicoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SbCsMedicoController c = (SbCsMedicoController) JsfUtil.obtenerBean("sbCsMedicoController", SbCsMedicoController.class);
            return c.getSbCsMedico(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SbCsMedico) {
                SbCsMedico o = (SbCsMedico) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SbCsMedico.class.getName());
            }
        }
    }
