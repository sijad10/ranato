...
@Named("eppCapacitacionController")
@SessionScoped

/**
 * Clase con EppCapacitacionController instanciada como
 * eppCapacitacionController. Contiene funciones utiles para la entidad
 * EppCapacitacion. Esta vinculada a las páginas EppCapacitacion/create.xhtml,
 * EppCapacitacion/update.xhtml, EppCapacitacion/list.xhtml,
 * EppCapacitacion/view.xhtml Nota: Las tablas deben tener la estructura de
 * Sucamec para que funcione adecuadamente, revisar si tiene el campo activo y
 * modificar las búsquedas.
 */
public class EppCapacitacionController implements Serializable {
     ...
     */
    EppCapacitacion registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<EppCapacitacion> resultados = null;

    /**
     * Lista de areas para seleccion multiple
     */
    List<EppCapacitacion> registrosSeleccionados;
     ...
     */
    @EJB
    private pe.gob.sucamec.bdintegrado.bean.EppCapacitacionFacade eppCapacitacionFacade;
     ...
     * @return
     */
    public List<EppCapacitacion> getRegistrosSeleccionados() {
     ...
     * @param a
     */
    public void setRegistrosSeleccionados(List<EppCapacitacion> a) {
    ...
    public void anularMultiple() {
        ...
        try {
            for (EppCapacitacion a : registrosSeleccionados) {
                a.setActivo((short) 0);
                eppCapacitacionFacade.edit(a);
            }
    ...
    public void activar() {
        try {
            registro = (EppCapacitacion) resultados.getRowData();
            registro.setActivo((short) 1);
            eppCapacitacionFacade.edit(registro);
     ...
     */
    public EppCapacitacion getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(EppCapacitacion registro) {
     ...
     */
    public ListDataModel<EppCapacitacion> getResultados() {
        return resultados;
    }
     ...
     */
    public List<EppCapacitacion> getSelectItems() {
        return eppCapacitacionFacade.findAll();
    }
     ...
     */
    public void buscar() {
        resultados = new ListDataModel(eppCapacitacionFacade.selectLike(filtro));
    }
    ...
    public void editar() {
        try {
            registro = (EppCapacitacion) JsfUtil.entidadMayusculas(registro, "");
            eppCapacitacionFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (EppCapacitacion) JsfUtil.entidadMayusculas(registro, "");
            eppCapacitacionFacade.create(registro);
     ...
     */
    public EppCapacitacion getEppCapacitacion(Long id) {
        return eppCapacitacionFacade.find(id);
    }
     ...
     *
     */
    public EppCapacitacionController() {
        estado = EstadoCrud.BUSCAR;
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "eppCapacitacionConverter")
    public static class EppCapacitacionControllerConverterN extends EppCapacitacionControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = EppCapacitacion.class)
    public static class EppCapacitacionControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            EppCapacitacionController c = (EppCapacitacionController) JsfUtil.obtenerBean("eppCapacitacionController", EppCapacitacionController.class);
            return c.getEppCapacitacion(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof EppCapacitacion) {
                EppCapacitacion o = (EppCapacitacion) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + EppCapacitacion.class.getName());
            }
        }
    }
}
