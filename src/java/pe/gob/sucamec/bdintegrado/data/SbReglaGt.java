...
public class SbReglaGt implements Serializable {
    ...
    @ManyToOne
    private SbPerfilGt perfilId;
    @JoinColumn(name = "PAGINA_ID", referencedColumnName = "ID")
    @ManyToOne(optional = false)
    private SbPaginaGt paginaId;

    public SbReglaGt() {
    }

    public SbReglaGt(Long id) {
        this.id = id;
    }

    public SbReglaGt(Long id, String nombre, String tabla, String campo, String condicion, String valor, short respuesta, int orden, short activo, String audLogin, String audNumIp) {
        this.id = id;
        this.nombre = nombre;
        this.tabla = tabla;
        this.campo = campo;
    ...
    public SbPerfilGt getPerfilId() {
        return perfilId;
    }

    public void setPerfilId(SbPerfilGt perfilId) {
        this.perfilId = perfilId;
    }

    public SbPaginaGt getPaginaId() {
        return paginaId;
    }

    public void setPaginaId(SbPaginaGt paginaId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SbReglaGt)) {
            return false;
        }
        SbReglaGt other = (SbReglaGt) object;
    ...
    public String toString() {
        return "pe.gob.sucamec.explosivos.data.SbRegla[ id=" + id + " ]";
    }
