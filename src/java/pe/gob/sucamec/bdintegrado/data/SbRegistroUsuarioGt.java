...
public class SbRegistroUsuarioGt implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SbRegistroUsuarioGt)) {
            return false;
        }
        SbRegistroUsuarioGt other = (SbRegistroUsuarioGt) object;
    ...
    public String toString() {
        return "pe.gob.sucamec.explosivos.data.SbRegistroUsuario[ id=" + id + " ]";
    }
