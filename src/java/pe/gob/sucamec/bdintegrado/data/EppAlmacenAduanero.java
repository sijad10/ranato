...
@Table(name = "EPP_ALMACEN_ADUANERO", catalog = "", schema = "BDINTEGRADO")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "EppAlmacenAduanero.findAll", query = "SELECT e FROM EppAlmacenAduanero e"),
    @NamedQuery(name = "EppAlmacenAduanero.findById", query = "SELECT e FROM EppAlmacenAduanero e WHERE e.id = :id"),
    @NamedQuery(name = "EppAlmacenAduanero.findByRazonSocial", query = "SELECT e FROM EppAlmacenAduanero e WHERE e.razonSocial = :razonSocial"),
    @NamedQuery(name = "EppAlmacenAduanero.findByDireccion", query = "SELECT e FROM EppAlmacenAduanero e WHERE e.direccion = :direccion"),
    @NamedQuery(name = "EppAlmacenAduanero.findByHabilitado", query = "SELECT e FROM EppAlmacenAduanero e WHERE e.habilitado = :habilitado"),
    @NamedQuery(name = "EppAlmacenAduanero.findByActivo", query = "SELECT e FROM EppAlmacenAduanero e WHERE e.activo = :activo"),
    @NamedQuery(name = "EppAlmacenAduanero.findByAudLogin", query = "SELECT e FROM EppAlmacenAduanero e WHERE e.audLogin = :audLogin"),
    @NamedQuery(name = "EppAlmacenAduanero.findByAudNumIp", query = "SELECT e FROM EppAlmacenAduanero e WHERE e.audNumIp = :audNumIp")})
public class EppAlmacenAduanero implements Serializable {

    private static final Long serialVersionUID = 1L;
    @Id
    @Basic(optional = false)
    @NotNull
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_EPP_ALMACEN_ADUANERO")
    @SequenceGenerator(name = "SEQ_EPP_ALMACEN_ADUANERO", schema = "BDINTEGRADO", sequenceName = "SEQ_EPP_ALMACEN_ADUANERO", allocationSize = 1)
    @Column(name = "ID")
    private Long id;
    @Basic(optional = false)
    @NotNull
    ...
    @OneToMany(mappedBy = "origAlmacenAduaId")
    private List<EppGuiaTransitoPiro> eppGuiaTransitoPiroList;
    @OneToMany(mappedBy = "destAlmacenAduaId")
    private List<EppGuiaTransitoPiro> eppGuiaTransitoPiroList1;
    @OneToMany(mappedBy = "destOrigAlmAduId")
    private List<EppInternaSalida> eppInternaSalidaList;
    @OneToMany(mappedBy = "verifAlmAduId")
    private List<EppInternaSalida> eppInternaSalidaList1;

    public EppAlmacenAduanero() {
    }

    public EppAlmacenAduanero(Long id) {
        this.id = id;
    }

    public EppAlmacenAduanero(Long id, String razonSocial, String direccion, short habilitado, short activo, String audLogin, String audNumIp) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        EppAlmacenAduanero other = (EppAlmacenAduanero) object;
    ...
    public String toString() {
        return "pe.gob.sucamec.bdintegrado.data.EppAlmacenAduanero[ id=" + id + " ]";
    }
