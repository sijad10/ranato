...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "ConsultaAmaTipoLicencia.findAll", query = "SELECT a FROM ConsultaAmaTipoLicencia a"),
    @NamedQuery(name = "ConsultaAmaTipoLicencia.findById", query = "SELECT a FROM ConsultaAmaTipoLicencia a WHERE a.id = :id"),
    @NamedQuery(name = "ConsultaAmaTipoLicencia.findByNroExpediente", query = "SELECT a FROM ConsultaAmaTipoLicencia a WHERE a.nroExpediente = :nroExpediente"),
    @NamedQuery(name = "ConsultaAmaTipoLicencia.findByActivo", query = "SELECT a FROM ConsultaAmaTipoLicencia a WHERE a.activo = :activo"),
    @NamedQuery(name = "ConsultaAmaTipoLicencia.findByAudLogin", query = "SELECT a FROM ConsultaAmaTipoLicencia a WHERE a.audLogin = :audLogin"),
    @NamedQuery(name = "ConsultaAmaTipoLicencia.findByAudNumIp", query = "SELECT a FROM ConsultaAmaTipoLicencia a WHERE a.audNumIp = :audNumIp")})
public class ConsultaAmaTipoLicencia implements Serializable {
    ...
    @SequenceGenerator(name = "SEQ_CONSULTA_AMA_TIPO_LICENCIA", schema = "BDINTEGRADO", sequenceName = "SEQ_AMA_TIPO_LICENCIA", allocationSize = 1)
    @Column(name = "ID")
    private Long id;
    @Basic(optional = false)
    @NotNull
    ...
    public ConsultaAmaTipoLicencia() {
    }

    public ConsultaAmaTipoLicencia(Long id) {
        this.id = id;
    }

    public ConsultaAmaTipoLicencia(Long id, String nroExpediente, short activo, String audLogin, String audNumIp) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ConsultaAmaTipoLicencia)) {
            return false;
        }
        ConsultaAmaTipoLicencia other = (ConsultaAmaTipoLicencia) object;
    ...
    public String toString() {
        return "pe.gob.sucamec.renagi.data.ConsultaAmaTipoLicencia[ id=" + id + " ]";
    }
