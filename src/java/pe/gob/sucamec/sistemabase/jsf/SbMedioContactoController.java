...
@Named("sbMedioContactoController")
@SessionScoped

/**
 * Clase con SbMedioContactoController instanciada como sbMedioContactoController. Contiene funciones utiles
 * para la entidad SbMedioContacto. Esta vinculada a las páginas SbMedioContacto/create.xhtml,
 * SbMedioContacto/update.xhtml, SbMedioContacto/list.xhtml, SbMedioContacto/view.xhtml Nota: Las tablas deben
 * tener la estructura de Sucamec para que funcione adecuadamente, revisar si tiene el campo activo y
 * modificar las búsquedas.
 */
public class SbMedioContactoController implements Serializable {
     ...
     */
    SbMedioContacto registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<SbMedioContacto> resultados = null;

    /**
     * Facade de la clase del controller, se pueden agregar más facades de acuerdo a la implementación.
     */
    @EJB
    private pe.gob.sucamec.sistemabase.beans.SbMedioContactoFacade sbMedioContactoFacade;
    ...
    public void activar() {
        try {
            registro = (SbMedioContacto) resultados.getRowData();
            registro.setActivo((short) 1);
            sbMedioContactoFacade.edit(registro);
     ...
     */
    public SbMedioContacto getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(SbMedioContacto registro) {
     ...
     */
    public ListDataModel<SbMedioContacto> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SbMedioContacto> getSelectItems() {
        return sbMedioContactoFacade.findAll();
    }
     ...
     */
    public void buscar() {
        //resultados = new ListDataModel(sbMedioContactoFacade.selectLike(filtro));
        resultados = new ListDataModel(sbMedioContactoFacade.findAll());
    }
    ...
    public void editar() {
        try {
            registro = (SbMedioContacto) JsfUtil.entidadMayusculas(registro, "");
            sbMedioContactoFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SbMedioContacto) JsfUtil.entidadMayusculas(registro, "");
            sbMedioContactoFacade.create(registro);
     ...
     *
     */
    public SbMedioContactoController() {
        estado = EstadoCrud.BUSCAR;
    }
     ...
     */
    @FacesConverter(forClass = SbMedioContacto.class)
    public static class SbMedioContactoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SbMedioContacto) {
                SbMedioContacto o = (SbMedioContacto) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SbMedioContacto.class.getName());
            }
        }
    }
}
