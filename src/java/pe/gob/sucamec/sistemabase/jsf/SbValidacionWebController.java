...
@Named("sbValidacionWebController")
@SessionScoped

/**
 * Clase con SbValidacionWebController instanciada como sbValidacionWebController. Contiene funciones utiles
 * para la entidad SbValidacionWeb. Esta vinculada a las páginas SbValidacionWeb/create.xhtml,
 * SbValidacionWeb/update.xhtml, SbValidacionWeb/list.xhtml, SbValidacionWeb/view.xhtml Nota: Las tablas deben
 * tener la estructura de Sucamec para que funcione adecuadamente, revisar si tiene el campo activo y
 * modificar las búsquedas.
 */
public class SbValidacionWebController implements Serializable {
     ...
     */
    SbValidacionWeb registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<SbValidacionWeb> resultados = null;

    /**
     * Facade de la clase del controller, se pueden agregar más facades de acuerdo a la implementación.
     */
    @EJB
    private pe.gob.sucamec.sistemabase.beans.SbValidacionWebFacade sbValidacionWebFacade;
    ...
    public void activar() {
        try {
            registro = (SbValidacionWeb) resultados.getRowData();
            registro.setActivo((short) 1);
            sbValidacionWebFacade.edit(registro);
     ...
     */
    public SbValidacionWeb getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(SbValidacionWeb registro) {
     ...
     */
    public ListDataModel<SbValidacionWeb> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SbValidacionWeb> getSelectItems() {
        return sbValidacionWebFacade.findAll();
    }
     ...
     */
    public void buscar() {
        //resultados = new ListDataModel(sbValidacionWebFacade.selectLike(filtro));
        resultados = new ListDataModel(sbValidacionWebFacade.findAll());
    }
    ...
    public void editar() {
        try {
            registro = (SbValidacionWeb) JsfUtil.entidadMayusculas(registro, "");
            sbValidacionWebFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SbValidacionWeb) JsfUtil.entidadMayusculas(registro, "");
            sbValidacionWebFacade.create(registro);
     ...
     *
     */
    public SbValidacionWebController() {
        estado = EstadoCrud.BUSCAR;
    }
     ...
     */
    @FacesConverter(forClass = SbValidacionWeb.class)
    public static class SbValidacionWebControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SbValidacionWeb) {
                SbValidacionWeb o = (SbValidacionWeb) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SbValidacionWeb.class.getName());
            }
        }
    }
}
