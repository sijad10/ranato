...
@Named("sbPerfilController")
@SessionScoped

/**
 * Clase con SbPerfilController instanciada como sbPerfilController. Contiene funciones utiles para la entidad
 * SbPerfil. Esta vinculada a las páginas SbPerfil/create.xhtml, SbPerfil/update.xhtml, SbPerfil/list.xhtml,
 * SbPerfil/view.xhtml Nota: Las tablas deben tener la estructura de Sucamec para que funcione adecuadamente,
 * revisar si tiene el campo activo y modificar las búsquedas.
 */
public class SbPerfilController implements Serializable {
     ...
     */
    ListDataModel<SbPerfil> resultados = null;

    /**
     * Facade de la clase del controller, se pueden agregar más facades de acuerdo a la implementación.
     */
    @EJB
    private pe.gob.sucamec.sistemabase.beans.SbPerfilFacade sbPerfilFacade;
    ...
    public void activar() {
        try {
            registro = (SbPerfil) resultados.getRowData();
            registro.setActivo((short) 1);
            sbPerfilFacade.edit(registro);
     ...
     */
    public void setRegistro(SbPerfil registro) {
     ...
     */
    public ListDataModel<SbPerfil> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SbPerfil> getSelectItems() {
        return sbPerfilFacade.findAll();
    }
     ...
     */
    public void buscar() {
        //resultados = new ListDataModel(sbPerfilFacade.selectLike(filtro));
        resultados = new ListDataModel(sbPerfilFacade.findAll());
    }
    
    /**
     * Obtiene una lista de Perfil para un selectOneMenu con los datos del controller, sin opción de nulos.
     *
     * @return Lista de SelectItems para un selectOneMenu o SelectList.
     */
    public SelectItem[] getItemsAvailableSelectMany() {
        return JsfUtil.getSelectItems(sbPerfilFacade.findAll(), false);
    }
    ...
    public void editar() {
        try {
            registro = (SbPerfil) JsfUtil.entidadMayusculas(registro, "");
            sbPerfilFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SbPerfil) JsfUtil.entidadMayusculas(registro, "");
            sbPerfilFacade.create(registro);
     ...
     */
    public SbPerfil getPerfil(Long id) {
        return sbPerfilFacade.find(id);
    }
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "sbPerfilConverter")
    public static class SbUsuarioControllerConverterN extends SbPerfilControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = SbPerfil.class)
    public static class SbPerfilControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            SbPerfilController c = (SbPerfilController) JsfUtil.obtenerBean("sbPerfilController", SbPerfilController.class);
            return c.getPerfil(Long.valueOf(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SbPerfil) {
                SbPerfil o = (SbPerfil) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SbPerfil.class.getName());
            }
        }
    }
}
