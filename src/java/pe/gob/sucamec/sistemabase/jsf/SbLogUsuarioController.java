...
@Named("sbLogUsuarioController")
@SessionScoped

/**
 * Clase con SbLogUsuarioController instanciada como sbLogUsuarioController. Contiene funciones utiles para la
 * entidad SbLogUsuario. Esta vinculada a las páginas SbLogUsuario/create.xhtml, SbLogUsuario/update.xhtml,
 * SbLogUsuario/list.xhtml, SbLogUsuario/view.xhtml Nota: Las tablas deben tener la estructura de Sucamec para
 * que funcione adecuadamente, revisar si tiene el campo activo y modificar las búsquedas.
 */
public class SbLogUsuarioController implements Serializable {
     ...
     */
    SbLogUsuario registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<SbLogUsuario> resultados = null;

    /**
     * Facade de la clase del controller, se pueden agregar más facades de acuerdo a la implementación.
     */
    @EJB
    private pe.gob.sucamec.sistemabase.beans.SbLogUsuarioFacade sbLogUsuarioFacade;
     ...
     */
    public SbLogUsuario getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(SbLogUsuario registro) {
     ...
     */
    public ListDataModel<SbLogUsuario> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SbLogUsuario> getSelectItems() {
        return sbLogUsuarioFacade.findAll();
    }
     ...
     */
    public void buscar() {
        //resultados = new ListDataModel(sbLogUsuarioFacade.selectLike(filtro));
        resultados = new ListDataModel(sbLogUsuarioFacade.findAll());
    }
    ...
    public void mostrarVer() {
        registro = (SbLogUsuario) resultados.getRowData();
    ...
    public void editar() {
        try {
            registro = (SbLogUsuario) JsfUtil.entidadMayusculas(registro, "");
            sbLogUsuarioFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
    ...
    public void crear() {
        try {
            registro = (SbLogUsuario) JsfUtil.entidadMayusculas(registro, "");
            sbLogUsuarioFacade.create(registro);
     ...
     */
    @FacesConverter(forClass = SbLogUsuario.class)
    public static class SbLogUsuarioControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SbLogUsuario) {
                SbLogUsuario o = (SbLogUsuario) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SbLogUsuario.class.getName());
            }
        }
    }
}
