...
@Named("sbTipoController")
@SessionScoped

/**
 * Clase con SbTipoController instanciada como sbTipoController. Contiene funciones utiles para la entidad
 * SbTipo. Esta vinculada a las páginas SbTipo/create.xhtml, SbTipo/update.xhtml, SbTipo/list.xhtml,
 * SbTipo/view.xhtml Nota: Las tablas deben tener la estructura de Sucamec para que funcione adecuadamente,
 * revisar si tiene el campo activo y modificar las búsquedas.
 */
public class SbTipoController implements Serializable {
     ...
     */
    ListDataModel<SbTipo> resultados = null;

    /**
     * Facade de la clase del controller, se pueden agregar más facades de acuerdo a la implementación.
     */
    @EJB
    private pe.gob.sucamec.sistemabase.beans.SbTipoFacade sbTipoFacade;
    ...
    public void activar() {
        try {
            registro = (SbTipo) resultados.getRowData();
            registro.setActivo((short) 1);
            sbTipoFacade.edit(registro);
     ...
     */
    public void setRegistro(SbTipo registro) {
     ...
     */
    public ListDataModel<SbTipo> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SbTipo> getSelectItems() {
        return sbTipoFacade.findAll();
    }
     ...
     */
    public void buscar() {
        //resultados = new ListDataModel(sbTipoFacade.selectLike(filtro));
        resultados = new ListDataModel(sbTipoFacade.findAll());
    }
    ...
    public void editar() {
        try {
            registro = (SbTipo) JsfUtil.entidadMayusculas(registro, "");
            sbTipoFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
     ...
     */
    @FacesConverter(forClass = SbTipo.class)
    public static class SbTipoControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SbTipo) {
                SbTipo o = (SbTipo) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SbTipo.class.getName());
            }
        }
    }
}
