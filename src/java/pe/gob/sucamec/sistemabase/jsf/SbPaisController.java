...
@Named("sbPaisController")
@SessionScoped

/**
 * Clase con SbPaisController instanciada como sbPaisController. Contiene
 * funciones utiles para la entidad SbPais. Esta vinculada a las páginas
 * SbPais/create.xhtml, SbPais/update.xhtml, SbPais/list.xhtml,
 * SbPais/view.xhtml Nota: Las tablas deben tener la estructura de Sucamec para
 * que funcione adecuadamente, revisar si tiene el campo activo y modificar las
 * búsquedas.
 */
public class SbPaisController implements Serializable {
     ...
     */
    ListDataModel<SbPais> resultados = null;
     ...
     */
    @EJB
    private pe.gob.sucamec.sistemabase.beans.SbPaisFacade sbPaisFacade;
     ...
     */
    public SbPais getSbPais(Long id) {
        return sbPaisFacade.find(id);
    }
    ...
    public List<SbPais> selectPaises() {
        return sbPaisFacade.selectPaisesActivos();
    }
    ...
    public void activar() {
        try {
            registro = (SbPais) resultados.getRowData();
            registro.setActivo((short) 1);
            sbPaisFacade.edit(registro);
     ...
     */
    public void setRegistro(SbPais registro) {
     ...
     */
    public ListDataModel<SbPais> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SbPais> getSelectItems() {
        return sbPaisFacade.findAll();
    }
     ...
     */
    public void buscar() {
        //resultados = new ListDataModel(sbPaisFacade.selectLike(filtro));
        resultados = new ListDataModel(sbPaisFacade.findAll());
    }
    ...
    public void editar() {
        try {
            registro = (SbPais) JsfUtil.entidadMayusculas(registro, "");
            sbPaisFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
     ...
     * controllers de JSF
     */
    @FacesConverter(value = "sbPaisConverter")
    public static class SbPaisControllerConverterN extends SbPaisControllerConverter {
    }

    /**
     * Converter, para selectOneMenus y otros controllers de JSF
     */
    @FacesConverter(forClass = SbPais.class)
    public static class SbPaisControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            try {
                ...
                SbPaisController c = (SbPaisController) JsfUtil.obtenerBean("sbPaisController", SbPaisController.class);
                return c.getSbPais(Long.valueOf(value));
            } catch (Exception ex) {
                return null;
            }
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SbPais) {
                SbPais o = (SbPais) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SbPais.class.getName());
            }
        }
    }
