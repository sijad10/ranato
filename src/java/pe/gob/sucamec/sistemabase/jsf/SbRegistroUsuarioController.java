...
import pe.gob.sucamec.sistemabase.data.SbRegistroUsuario;
...
@Named("sbRegistroUsuarioController")
@SessionScoped

/**
 * Clase con SbRegistroUsuarioController instanciada como sbRegistroUsuarioController. Contiene funciones
 * utiles para la entidad SbRegistroUsuario. Esta vinculada a las páginas SbRegistroUsuario/create.xhtml,
 * SbRegistroUsuario/update.xhtml, SbRegistroUsuario/list.xhtml, SbRegistroUsuario/view.xhtml Nota: Las tablas
 ...
 */
public class SbRegistroUsuarioController implements Serializable {
     ...
     */
    SbRegistroUsuario registro;

    /**
     * Lista de resultados de la búsqueda
     */
    ListDataModel<SbRegistroUsuario> resultados = null;

    /**
     * Facade de la clase del controller, se pueden agregar más facades de acuerdo a la implementación.
     */
    @EJB
    private pe.gob.sucamec.sistemabase.beans.SbRegistroUsuarioFacade sbRegistroUsuarioFacade;
    ...
    public void activar() {
        try {
            registro = (SbRegistroUsuario) resultados.getRowData();
            registro.setActivo((short) 1);
            sbRegistroUsuarioFacade.edit(registro);
     ...
     */
    public SbRegistroUsuario getRegistro() {
        return registro;
    }
     ...
     */
    public void setRegistro(SbRegistroUsuario registro) {
     ...
     */
    public ListDataModel<SbRegistroUsuario> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SbRegistroUsuario> getSelectItems() {
        return sbRegistroUsuarioFacade.findAll();
    }
     ...
     */
    public void buscar() {
        //resultados = new ListDataModel(sbRegistroUsuarioFacade.selectLike(filtro));
        resultados = new ListDataModel(sbRegistroUsuarioFacade.findAll());
    }
    ...
    public void mostrarCrear() {
        ...
        registro = new SbRegistroUsuario();
        registro.setActivo((short) 1);
    }
    ...
    public void editar() {
        try {
            registro = (SbRegistroUsuario) JsfUtil.entidadMayusculas(registro, "");
            sbRegistroUsuarioFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SbRegistroUsuario) JsfUtil.entidadMayusculas(registro, "");
            sbRegistroUsuarioFacade.create(registro);
     ...
     *
     */
    public SbRegistroUsuarioController() {
        estado = EstadoCrud.BUSCAR;
    }
     ...
     */
    @FacesConverter(forClass = SbRegistroUsuario.class)
    public static class SbRegistroUsuarioControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return new SbRegistroUsuario(id);
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SbRegistroUsuario) {
                SbRegistroUsuario o = (SbRegistroUsuario) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SbRegistroUsuario.class.getName());
            }
        }
    }
}
