...
@Named("sbSistemaController")
@SessionScoped

/**
 * Clase con SbSistemaController instanciada como sbSistemaController. Contiene funciones utiles para la
 * entidad SbSistema. Esta vinculada a las páginas SbSistema/create.xhtml, SbSistema/update.xhtml,
 * SbSistema/list.xhtml, SbSistema/view.xhtml Nota: Las tablas deben tener la estructura de Sucamec para que
 * funcione adecuadamente, revisar si tiene el campo activo y modificar las búsquedas.
 */
public class SbSistemaController implements Serializable {
     ...
     */
    ListDataModel<SbSistema> resultados = null;

    /**
     * Facade de la clase del controller, se pueden agregar más facades de acuerdo a la implementación.
     */
    @EJB
    private pe.gob.sucamec.sistemabase.beans.SbSistemaFacade sbSistemaFacade;
    ...
    public void activar() {
        try {
            registro = (SbSistema) resultados.getRowData();
            registro.setActivo((short) 1);
            sbSistemaFacade.edit(registro);
     ...
     */
    public void setRegistro(SbSistema registro) {
     ...
     */
    public ListDataModel<SbSistema> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SbSistema> getSelectItems() {
        return sbSistemaFacade.findAll();
    }
     ...
     */
    public void buscar() {
        //resultados = new ListDataModel(sbSistemaFacade.selectLike(filtro));
        resultados = new ListDataModel(sbSistemaFacade.findAll());
    }
    ...
    public void editar() {
        try {
            registro = (SbSistema) JsfUtil.entidadMayusculas(registro, "");
            sbSistemaFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SbSistema) JsfUtil.entidadMayusculas(registro, "");
            sbSistemaFacade.create(registro);
     ...
     */
    @FacesConverter(forClass = SbSistema.class)
    public static class SbSistemaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SbSistema) {
                SbSistema o = (SbSistema) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SbSistema.class.getName());
            }
        }
    }
}
