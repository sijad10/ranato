...
public class JsfUtil {
    ...
    public static void borrarIds(List datos) throws Exception {
        ...
        for (Iterator<Object> it = datos.iterator(); it.hasNext();) {
            Object o = it.next();
    ...
    public static SelectItem[] getSelectItems(List<?> entities, boolean selectOne) {
        return getSelectItems(entities, selectOne, null, null);
    }
    
    public static SelectItem[] getSelectItems(List<?> entities, boolean selectOne, String field) {
        return getSelectItems(entities, selectOne, field, null);
    }
     ...
     * @return Una lista del tipo array SelectItem.
     */
    public static SelectItem[] getSelectItems(List<?> entities, boolean selectOne, String field, String idx) {
            ...
            for (Object x : entities) {
                if (field == null) {
                    ...
                    if (idx == null) {
                        ...
                        Field f2 = x.getClass().getDeclaredField(idx);
                        f2.setAccessible(true);
                        String val2 = f2.get(x).toString();
                        items[i++] = new SelectItem(val2, val);
                    }
                }
            }
    ...
    private final static String[][] listaErrores = {
        ...
        {"BDINTEGRADO.UN01USUARIO_PERSONAID_LOGIN", "Error el Login se encuentra duplicado."},};
    ...
    /**
     * Valida que un texto con números sea un número
     *
     * @param numero Texto con el número
     * @return true si es un número, false si no lo es.
     */
    public static boolean ValidarNumero(String numero) {
        try {
            Long dummy = Long.parseLong(numero);
            return true;
        } catch (Exception e) {
            return false;
        }
    ...
    public static String leftpadString(String text, int length, String caracter) {
        String res = String.format("%1$" + length + "s", text);
        return res.replace(" ", caracter);
    }
