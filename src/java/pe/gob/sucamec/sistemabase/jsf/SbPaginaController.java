...
@Named("sbPaginaController")
@SessionScoped

/**
 * Clase con SbPaginaController instanciada como sbPaginaController. Contiene funciones utiles para la entidad
 * SbPagina. Esta vinculada a las páginas SbPagina/create.xhtml, SbPagina/update.xhtml, SbPagina/list.xhtml,
 * SbPagina/view.xhtml Nota: Las tablas deben tener la estructura de Sucamec para que funcione adecuadamente,
 * revisar si tiene el campo activo y modificar las búsquedas.
 */
public class SbPaginaController implements Serializable {
     ...
     */
    ListDataModel<SbPagina> resultados = null;

    /**
     * Facade de la clase del controller, se pueden agregar más facades de acuerdo a la implementación.
     */
    @EJB
    private pe.gob.sucamec.sistemabase.beans.SbPaginaFacade sbPaginaFacade;
    ...
    public void activar() {
        try {
            registro = (SbPagina) resultados.getRowData();
            registro.setActivo((short) 1);
            sbPaginaFacade.edit(registro);
     ...
     */
    public void setRegistro(SbPagina registro) {
     ...
     */
    public ListDataModel<SbPagina> getResultados() {
        return resultados;
    }
     ...
     */
    public List<SbPagina> getSelectItems() {
        return sbPaginaFacade.findAll();
    }
     ...
     */
    public void buscar() {
        //resultados = new ListDataModel(sbPaginaFacade.selectLike(filtro));
        resultados = new ListDataModel(sbPaginaFacade.findAll());
    }
    ...
    public void editar() {
        try {
            registro = (SbPagina) JsfUtil.entidadMayusculas(registro, "");
            sbPaginaFacade.edit(registro);
            estado = EstadoCrud.BUSCAR;
            JsfUtil.mensaje(JsfUtil.bundle("MensajeRegistroActualizado"));
        } catch (Exception e) {
    ...
    public void crear() {
        try {
            registro = (SbPagina) JsfUtil.entidadMayusculas(registro, "");
            sbPaginaFacade.create(registro);
     ...
     */
    @FacesConverter(forClass = SbPagina.class)
    public static class SbPaginaControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof SbPagina) {
                SbPagina o = (SbPagina) object;
                return o.getId().toString();
            } else {
                throw new IllegalArgumentException("El objeto " + object + " es del tipo " + object.getClass().getName() + "; se esperaba: " + SbPagina.class.getName());
            }
        }
    }
}
