...
public class SbValidacionWeb implements Serializable {
    ...
    public SbValidacionWeb() {
    }

    public SbValidacionWeb(Long id) {
        this.id = id;
    }

    public SbValidacionWeb(Long id, short activo, String audLogin, String audNumIp) {
        this.id = id;
        this.activo = activo;
    ...
    public boolean equals(Object object) {
        ...
        SbValidacionWeb other = (SbValidacionWeb) object;
    ...
    public String toString() {
        return "pe.gob.sucamec.sistemabase.data.SbValidacionWeb[ id=" + id + " ]";
    }
