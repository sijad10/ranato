...
public class JsfUtil {
    ...
    public static boolean enviarCorreo(String destino, String asunto, String mensaje) {
        try {
            ...
            email.setHostName(pe.gob.sucamec.notificacion.jsf.util.JsfUtil.bundle("Correo_Servidor"));
            email.setSmtpPort(25);
            email.setFrom(pe.gob.sucamec.notificacion.jsf.util.JsfUtil.bundle("Correo_Cuenta"));
    ...
    /**
     * Envía un correo electrónico desde GMAIL
     *
     * @param destino correo de destino
     * @param asunto asunto
     * @param mensaje mensaje de correo
     * @return
     */
    public static boolean enviarCorreoGmail(String destino, String asunto, String mensaje) {
        try {
            Email email = new SimpleEmail();
            email.setHostName("smtp.gmail.com");
            email.setSmtpPort(25);//25 587
            email.setFrom("sucamec.notificaciones@gmail.com","SUCAMEC Notificaciones");
            email.setAuthentication("sucamec.notificaciones@gmail.com", "dfbd19383d7b517b9b197b9c07a2a20d");
            //email.setAuthenticator(new DefaultAuthenticator("sucamec.notificaciones@gmail.com", "dfbd19383d7b517b9b197b9c07a2a20d"));
            email.setCharset("UTF-8");
            email.setSubject(asunto);
            email.setMsg(mensaje);
            email.addTo(destino);
